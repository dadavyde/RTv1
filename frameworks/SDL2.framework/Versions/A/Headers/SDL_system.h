...
/**
   ...
   on which monitor a full screen_ application will appear.
*/
...
extern DECLSPEC int SDLCALL SDL_iPhoneSetAnimationCallback(SDL_Window * window_, int interval, void (*callback)(void*), void *callbackParam);
